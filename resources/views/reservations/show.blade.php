                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        @auth
                            ...
                            @if ($reservation)
                                <a href="{{ route('reservation.show', $reservation->id) }}" class="nav-item nav-link active">
                                    Ma Réservation
                                </a>
                            @endif
                        @endauth
    ...
    <div class="container">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="d-flex align-items-center mt-3">
                ...
                <div>
                    <p class="mb-0">Utilisez ce numéro pour toute communication avec notre service client.</p>
        ...
        <script>
            ...
            <div class="row g-5">
                    ...
                    <div class="card border-0 shadow rounded-4 h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="row mb-4">
                                ...
                                <div class="col-md-8">
                                    <h4 class="text-primary">{{ $reservation->vehicule->marque }} {{ $reservation->vehicule->model }}</h4>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <p class="mb-1"><i class="fas fa-users text-primary me-2"></i> {{ $reservation->vehicule->capacite }} places</p>
                                        </div>
                                        <div class="col-6">
                                            <p class="mb-1"><i class="fas fa-gas-pump text-primary me-2"></i> {{ ucfirst($reservation->vehicule->type_carburant) }}</p>
                                        </div>
                                        <div class="col-6">
                                            <p class="mb-1"><i class="fas fa-cogs text-primary me-2"></i> {{ ucfirst($reservation->vehicule->transmission) }}</p>
                                        </div>
                                        <div class="col-6">
                                            <p class="mb-1"><i class="fas fa-road text-primary me-2"></i> {{ number_format($reservation->vehicule->kilometrage) }} km</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-light p-4 rounded-3">
                                <h5 class="mb-3"><i class="fas fa-calendar-alt text-primary me-2"></i> Période de location</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Date de début:</strong></p>
                                        <p class="bg-white p-2 rounded">{{ \Carbon\Carbon::parse($reservation->dateDebut)->format('d/m/Y') }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="mb-1"><strong>Date de fin:</strong></p>
                                        <p class="bg-white p-2 rounded">{{ \Carbon\Carbon::parse($reservation->dateFin)->format('d/m/Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3">
                                    <h5 class="mb-3"><i class="fas fa-money-bill-wave text-primary me-2"></i> Détails du paiement</h5>
                                    <div class="bg-white p-3 rounded">
                                        <div class="d-flex justify-content-between mb-2">
                                            <span>{{ $reservation->vehicule->tarif }} DH × {{ $days }} jours</span>
                                            <span>{{ $reservation->vehicule->tarif * $days }} DH</span>
                                        </div>
                                        <hr>
                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow rounded-4 h-100">
                        <div class="card-header bg-primary text-white rounded-top-4 py-3">
                            <h3 class="mb-0"><i class="fas fa-user-circle me-2"></i> Informations Client</h3>
                        </div>
                        <div class="card-body p-4">
                            <div class="mb-4">
                                <h5 class="text-primary mb-3"><i class="fas fa-id-card me-2"></i> Client</h5>
                                <div class="bg-light p-3 rounded">
                                    <p class="mb-1"><strong>Nom complet:</strong> {{ $reservation->client->nom_complet }}</p>
                                    <p class="mb-0"><strong>Email:</strong> {{ $reservation->client->user->email }}</p>
                                </div>
                            </div>

                            <div class="mb-4">
                                <h5 class="text-primary mb-3"><i class="fas fa-car me-2"></i> Statut de la réservation</h5>
                                <div class="p-3 rounded bg-light">
                                    ...
                                    @endphp
                                    <span class="badge bg-{{ $statusClass }} py-2 px-3 fs-6">{{ ucfirst($reservation->statut) }}</span>
                                    <p class="mt-2 mb-0">Votre réservation est actuellement {{ strtolower($reservation->statut) }}.</p>
                                </div>
                            </div>

                            <div>
                                <h5 class="text-primary mb-3"><i class="fas fa-id-card me-2"></i> Permis de conduire</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="border p-2 rounded bg-white text-center">
                                            <p class="fw-bold mb-2">Recto</p>
                                            <img src="{{ asset('storage/permis/' . $reservation->client_id . '__recto.jpg') }}"
                                                alt="Permis Recto"
                                    ...
                                    <div class="col-md-6">
                                        <div class="border p-2 rounded bg-white text-center">
                                            ...
                                            <img src="{{ asset('storage/permis/' . $reservation->client_id . '__verso.jpg') }}"
                                                alt="Permis Verso"
                                                class="img-fluid rounded shadow-sm"
                                                style="max-height: 200px;">
                                        </div>
            ...
            <div class="text-center mt-5">
                ...
                <a href="{{ route('reservation.download', $reservation->id) }}" class="btn btn-primary btn-lg px-4">
                    <i class="fas fa-file-pdf me-2"></i> Télécharger en PDF
                </a>

                @if(strtolower($reservation->statut) === 'en attente')
                    <form action="{{ route('reservation.cancel', $reservation->id) }}" method="POST" class="d-inline-block ms-3">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-lg px-4" onclick="return confirm('Êtes-vous sûr de vouloir annuler cette réservation?')">
